...
PICS = (environ.get('PICS', 'https://graph.org/file/20a9ea343fb75429d4c76.jpg')).split()
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Moviedatabase:Moviedatabase@cluster0.0bise.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001393735301'))
